...
g++ -c test.cpp $(pkg-config --libs --cflags cairo) -lX11&&g++ test.o -o sfml-app -lsfml-graphics -lsfml-window -lsfml-system -lXtst -lX11 -lXfixes $(pkg-config --libs --cflags cairo) && sudo ./sfml-app
